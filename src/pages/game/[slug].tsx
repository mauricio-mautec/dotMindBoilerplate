...
// como getStaticProps é uma função que vai gerar a página em build time, é preciso que o nextjs
// conheça todas as rotas possíveis para deixá-las disponibilizadas: getStaticPaths()
// (/game/bla, /game/foo, ...), no caso apenas a rota /game/cyberpunk-2077 estará disponibilizada
// e qualquer outra tentativa vai resultar em 404
