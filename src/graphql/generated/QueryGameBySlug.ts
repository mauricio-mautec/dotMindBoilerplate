...
export interface QueryGameBySlug_games_data_attributes_galery_data_attributes {
  __typename: "UploadFile";
  src: string;
  label: string | null;
}

export interface QueryGameBySlug_games_data_attributes_galery_data {
  __typename: "UploadFileEntity";
  attributes: QueryGameBySlug_games_data_attributes_galery_data_attributes | null;
}

export interface QueryGameBySlug_games_data_attributes_galery {
  __typename: "UploadFileRelationResponseCollection";
  data: QueryGameBySlug_games_data_attributes_galery_data[];
}
...
export interface QueryGameBySlug_games_data_attributes {
  ...
  galery: QueryGameBySlug_games_data_attributes_galery | null;
